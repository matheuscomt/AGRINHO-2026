...
HTML, CSS e JavaScript ficam em **arquivos separados**, todos na raiz do projeto ao lado da `index.html`.
...
Como os arquivos estão na raiz do projeto, é só subir tudo para o repositório e ativar em *Settings → Pages* → branch `main` + `/ (root)`. O site fica no ar em `https://<usuario>.github.io/<repositorio>/`.
